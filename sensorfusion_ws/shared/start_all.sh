...
docker run -d \
    ...
    /bin/bash -c "export RMW_IMPLEMENTATION=rmw_fastrtps_cpp && source /opt/ros/humble/install/setup.bash && source /ros2_ws/install/setup.bash 2>/dev/null || true && sleep infinity"
